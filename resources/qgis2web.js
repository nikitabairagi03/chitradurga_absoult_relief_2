...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32643',
            //extent: [607057.801817, 1500164.607983, 720366.030889, 1663976.598177],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([559582.877200, 1491225.522831, 759481.015346, 1665231.562304], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CHITRADURGA ABSOLUTE RELIEF</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (560 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The absolute relief of Chitradurga district is generally moderate to high, as the region is characterized by rocky uplands and uneven terrain. Elevation varies significantly across the district, with hill ranges and residual uplands occupying many parts of the area. The northern, eastern, and southern regions show comparatively higher relief, while lower relief zones occur in valley plains and gently sloping surfaces. Overall, Chitradurga exhibits an undulating and rugged landscape shaped by ancient hard rock formations and long-term erosional processes.';
            }
